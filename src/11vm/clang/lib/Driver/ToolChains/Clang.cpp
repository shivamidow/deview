...
void Clang::ConstructJob(Compilation &C, const JobAction &JA,
  ...
  if (Args.getLastArg(options::OPT_enable_web_api_marking_EQ)) {
    CmdArgs.push_back("-enable_web_api_marking=1");
  }
  if (Args.getLastArg(options::OPT_enable_web_api_profiling_EQ)) {
    CmdArgs.push_back("-enable_web_api_profiling=1");
  }
