...
static bool ParseCodeGenArgs(CodeGenOptions &Opts, ArgList &Args, InputKind IK,
  ...
  if (Args.hasArg(OPT_enable_web_api_marking_value)) {
    Opts.enable_web_api_marking = true;
  }
  if (Args.hasArg(OPT_enable_web_api_profiling_value)) {
    Opts.enable_web_api_profiling = true;
  }
